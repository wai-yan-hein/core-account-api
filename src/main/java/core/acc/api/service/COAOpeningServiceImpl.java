...
public class COAOpeningServiceImpl implements COAOpeningService {
    ...
    @Override
    public List<COAOpening> searchOpening(String opDate, String deptCode, String curCode, String traderType,
                                          String coaLv1, String coaLv2, String coaLv3,String projectNo, String compCode) {
