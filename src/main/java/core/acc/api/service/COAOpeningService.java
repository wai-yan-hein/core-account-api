...
public interface COAOpeningService {
    ...
    List<TmpOpening> getCOAOpening(String coaCode, String opDate, String clDate, int level, String curr, String compCode, List<String> department, Integer macId, String traderCode) throws Exception;
